import {
  Activity, AlertTriangle, Ban, CalendarX, ClipboardCheck,
  ClipboardList, Coffee, GaugeCircle, Sun, Timer,
} from "lucide-react";
...
export function KpiGrid() {
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
      <StatCard label="Working" value={k.working} icon={Activity} trend={{ direction: "up", value: "+2", intent: "positive" }} />
      <StatCard label="On break" value={k.onBreak} icon={Coffee} />
      <StatCard label="Late" value={k.late} icon={Timer} trend={{ direction: "flat", value: "0" }} hint="vs yesterday" />
      <StatCard label="Absent" value={k.absent} icon={CalendarX} trend={{ direction: "up", value: "+1", intent: "negative" }} />
