...
export const seedComments: TaskThreadComment[] =
  T.length === 0
    ? []
    : [
        c(
          ...
          0,
          "emp_002",
          "Kicking this off — pulled the spec from Notion. @emp001 can you review the schema before I code?",
          3,
          null,
          ["emp_001"],
        ...
        c(
          ...
          0,
          "emp_002",
          "Done. Pushed migration to the branch.",
          1,
          "tc_001",
          [],
        ...
        c("tc_010", 1, "emp_003", "Blocked on the design tokens. @emp005 any update?", 4, null, [
          "emp_005",
        ]),
        c(
          "tc_011",
          1,
          "emp_005",
          "Tokens shipped this morning. Pull latest from main.",
          3,
          "tc_010",
          [],
        ...
        c(
          ...
          2,
          "emp_001",
          "Loving the empty state. Tiny nit — the icon weight feels heavy.",
          4,
          "tc_020",
        ),
        c(
          ...
          2,
          "emp_006",
          "Switched to the lucide line variant.",
          2,
          "tc_020",
          [],
        ...
        c(
          ...
          6,
          "emp_004",
          "Closing this one out — verified in staging.",
          0,
          null,
          [],
...
export const seedFiles: TaskFile[] =
  T.length === 0
    ? []
    : [
