    ...
    <div className="mb-6 flex flex-wrap items-center gap-2 rounded-xl border border-border bg-surface/40 p-3">
      ...
      {scope !== "personal" && (
        <Select
          ...
          onValueChange={(v) => setFilters({ department: v === "all" ? undefined : v })}
        >
      ...
      {(scope === "team" || scope === "executive") && (
        <Select
          ...
          onValueChange={(v) => setFilters({ team: v === "all" ? undefined : v })}
        >
      ...
      {scope === "team" && (
        <Select
          ...
          onValueChange={(v) => setFilters({ employee: v === "all" ? undefined : v })}
        >
      ...
      {(scope === "team" || scope === "executive") && (
        <Select
          ...
          onValueChange={(v) => setFilters({ project: v === "all" ? undefined : v })}
        >
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <Tabs
          ...
          onValueChange={(v) => setFilters({ benchmark: v as BenchmarkPeriod })}
        >
