  ...
  public: {
    Tables: {
      ...
      general_email_deliveries: {
        ...
        Relationships: [
          {
            foreignKeyName: "general_email_deliveries_email_id_fkey";
            columns: ["email_id"];
            isOneToOne: false;
            referencedRelation: "general_emails";
            referencedColumns: ["id"];
          },
          {
      ...
      payslip_edit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "payslip_edit_log_applied_delivery_id_fkey";
            columns: ["applied_delivery_id"];
            isOneToOne: false;
            referencedRelation: "payslip_deliveries";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "payslip_edit_log_delivery_id_fkey";
            columns: ["delivery_id"];
            isOneToOne: false;
            referencedRelation: "payslip_deliveries";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      _overtime_rate_for: {
        Args: { _employee_id: string; _ref: string };
      ...
      overtime_pay_for_hours: {
        Args: { _employee_id: string; _hours: number; _ref: string };
        Returns: number;
      };
      overtime_pay_report: {
