  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          // min-w-0 lets this flex column shrink to the viewport instead of
          // growing to fit wide content. Without it, overflow-x-auto regions
          // (tab subnavs, tables) push the whole page wider than the screen.
